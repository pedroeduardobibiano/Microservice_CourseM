...
public class ModuleServiceImpl implements ModuleService {
    ...
    @Override
    public List<ModuleDTO> findAll(UUID id) {
        List<ModuleModel> module = moduleRepository.findAllModulesIntoCourse(id);
        return module.stream().map(ModuleDTO::new).collect(Collectors.toList());
    }
